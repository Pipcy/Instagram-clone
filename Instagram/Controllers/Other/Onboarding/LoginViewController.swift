...
//
import SafariServices //for terms and privacy to go to safari pages
import UIKit

class LoginViewController: UIViewController {
    
    //keep a list of commonly used numbers as constants
    struct Constants {
    ...
    private let usernameEmailField: UITextField = {
        ...
        field.layer.cornerRadius = Constants.cornerRadius //reference constants
...
//        field.layer.borderColor = UIColor.secondaryLabel.cgColor
    ...
    private let passwordField: UITextField = {
        let field = UITextField()
        field.isSecureTextEntry = true //show stars
...
//        field.layer.borderColor = UIColor.secondaryLabel.cgColor
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = .systemBackground //primary system color
    }
    ...
    override func viewDidLayoutSubviews() {
        ...
        headerView.frame = CGRect(
            ...
            width: view.width, //used extension
        ...
        usernameEmailField.frame = CGRect(
            ...
            width: view.width-50, //used extension
            height: 52.0)
