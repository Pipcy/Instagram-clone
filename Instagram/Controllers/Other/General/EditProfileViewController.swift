...
final class EditProfileViewController: UIViewController, UITableViewDataSource {
    ...
    @objc private func didTapChangeProfilePicture() {
        ...
        actionSheet.popoverPresentationController?.sourceView = view //prevent ipad crashing
        actionSheet.popoverPresentationController?.sourceRect = view.bounds //same
...
extension EditProfileViewController: FormTableViewCellDelegate {
    func formTableViewCell(_ cell: FormTableViewCell, didUpdateFeld updatedModel: EditProfileFormModel) {
        ...
        //update the model
        //check: print(updatedModel.value ?? "nil")
